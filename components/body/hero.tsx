    ...
    return (
        <div className="flex flex-col items-center justify-center h-screen space-y-14">
            ...
            <button className="bg-gradient-to-br from-pastelgreen dark:from-primary-dark-main to-turquoise dark:to-aquamarine z-10 font-inter font-semibold text-xl space-x-4 p-5 rounded-lg">
                <FontAwesomeIcon icon={faRocket} className="space-x-4 text-neutral-100 dark:text-neutral-900" /><span className="text-neutral-100 dark:text-neutral-900">Ayo Mulai Sekarang</span>
            </button>
        </div>
    )
}
